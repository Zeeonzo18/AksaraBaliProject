...
background_image = Image.open("Malajah Aksara Bali.png")  # Ganti dengan path gambar
...
gambar_asli = Image.open("Malajah Aksara Bali.png")
gambar_resized = gambar_asli.resize((600, 100))
